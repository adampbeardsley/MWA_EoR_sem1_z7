...
\caption{
\textbf{
Error level corresponding to Figure~\ref{fig:example_ps}. The noise is relatively low at
...
\textbf{Figure~\ref{fig:example_2derror} shows the error level corresponding to the two 
dimensional power spectrum in Figure~\ref{fig:example_ps}. These errors
...
The noise is mostly constant across $k_{||}$ because the Fourier transform distributes
the noise in frequency to all modes equally \citep{Morales:2004}.
