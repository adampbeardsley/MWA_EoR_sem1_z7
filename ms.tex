...
Hazelton:2013, Pober:2013, Thyagarajan:2013, Vedantham:2012, Morales:2012, Datta:2010}. Despite this 
...
EoR experiment. 
This strategy is in contrast to more pointed EoR experiments like PAPER, 
...
channelization of the data (1.28 MHz coarse bands)\citep{Prabu:2015}. This channelization 
...
significantly below the predicted cosmological signal levels. This improvement in beam
...
EoR window \citep{Thyagarajan:2015b, Thyagarajan:2015, Pober:2016}. In principle we 
...
FHD. We test for residual flux at source locations by calculating a fractional residual flux RMS 
...
of the vertical streaks due to poor sampling at large $(u,v)$. While the increased noise would
...
of $k_{\perp}$ for fixed $k_{||}$, averaged in rings from the full 3D power cube (blue). The grey boxes show regions which will be excluded from
